    ...
    <>
      ...
      <div className="mt-15 px-4 py-30 bg-[linear-gradient(135deg,hsl(215_50%_18%),hsl(215_85%_45%))]">
        ...
        >
          ...
          <h1 className="text-4xl font-bold text-white">About Omega Tutorials – Best Coaching Institute in Gurugram</h1>
          <p className="text-white/80">Omega Tutorials is a leading coaching institute in Gurugram offering expert coaching for Classes 9–12, IIT-JEE, and NEET with proven academic results.</p>
        </motion.div>
      </div>
      ...
      <div className='py-12 lg:py-24 px-4 lg:px-16 flex flex-col gap-8 bg-white'>
        <motion.p className='text-lg text-[hsl(215_30%_15%)]/80 leading-relaxed text-justify max-w-5xl mx-auto'
          ...
          viewport={{ once: true }}
        >
          Omega Tutorials is one of the best coaching institutes in Gurugram, providing high-quality coaching for students from Classes 9 to 12. We specialize in Maths, Science, IIT-JEE, and NEET preparation with a strong focus on concept clarity and exam performance.
        </motion.p>
        <motion.p className='text-lg text-[hsl(215_30%_15%)]/80 leading-relaxed text-justify max-w-5xl mx-auto'
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        >
          With over 29 years of teaching experience, Omega Tutorials has helped thousands of students achieve excellent results in board exams and competitive exams. Our personalized teaching approach, small batch sizes, and regular assessments make us a trusted name among parents and students in Gurugram.
        </motion.p>
      </div>

      {/* Vision and Mission */}
      <div className='py-12 lg:py-24 px-4 lg:px-16 max-w-6xl mx-auto flex flex-col gap-12'>
        <h2 className="text-3xl font-bold text-center mx-auto max-w-4xl">Our Vision & Mission as a Leading Coaching Institute in Gurugram</h2>
      ...
      <div className='py-12 lg:py-24 px-4 lg:px-16 flex flex-col items-center gap-12'>
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215_30%_15%)] text-center">Our Teaching Methodology for Academic Success in Gurugram</h2>
      ...
      <div className='py-12 lg:py-24 px-4 lg:px-16 flex flex-col items-center gap-12 bg-[hsl(210_33%_98%)]'>
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215_30%_15%)] text-center">Why Parents Choose Our Coaching Classes in Gurugram</h2>
        </motion.div>
      ...
      <div className="hidden">
        <h2>Best Coaching Institute in Gurugram</h2>
        <p>Omega Tutorials is a top-rated coaching institute in Gurugram offering Maths, Science, IIT-JEE, and NEET coaching. Known for experienced faculty, small batches, and excellent results, we are a preferred choice for students.</p>
      </div>
    </>
  )
}
