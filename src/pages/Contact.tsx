...
const Contact = () => {
  ...
  return (
    <>
      ...
      <section className="py-20 bg-[hsl(210_33%_98%)]">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-8">
              <div>
                ...
                <div className="space-y-5">
                  {[
                    { icon: MapPin, label: "Visit Us", value: "Sec 4 & 5 crossing, Old Railway Rd, near Panjiri Plant, Gurgoan, India" },
                    { icon: Phone, label: "Call Us", value: "+91 9868495901" },
                    { icon: Mail, label: "Email Us", value: "omegatutorials2@gmail.com" },
                  ].map((item, i) => (
                    <div key={i} className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="text-sm font-medium text-[hsl(215_15%_50%)]">{item.label}</p>
